...
export class DataApiService {
    ...
    watsonTTS(text: string): Observable<any> {
        return this.http
            .get<any>(`http://localhost:8080/api/watson/tts?text=${text}.`)
    ...
    getToken(): Observable<any> {
        return this.http
            .get<any>(`http://localhost:8080/api/speech-to-text/token`)
            .pipe(catchError(async (error) => console.log(error)));
    }
    ...
    addApplicant(applicant): Observable<any> {
        return this.http
            .put<any>(
                `http://localhost:8080/api/applicant/add`,
                applicant,
                httpOptions
            )
            .pipe(catchError(async (error) => console.log(error)));
    ...
    getApplications(): Observable<any> {
        return this.http
            .get<any>(`http://localhost:8080/api/applications`)
            .pipe(catchError(async (error) => console.log(error)));
    }
    ...
    getApplicationByID(id): Observable<any> {
        return this.http
            .get<any>(`http://localhost:8080/api/applications/${id}`)
            .pipe(catchError(async (error) => console.log(error)));
    }
    ...
    getApplicantsByAppID(id): Observable<any> {
        return this.http
            .get<any>(`http://localhost:8080/api/applicants/${id}`)
            .pipe(catchError(async (error) => console.log(error)));
    }
    ...
    getApplicantByID(id): Observable<any> {
        return this.http
            .get<any>(`http://localhost:8080/api/applicant/${id}`)
            .pipe(catchError(async (error) => console.log(error)));
    }
}
